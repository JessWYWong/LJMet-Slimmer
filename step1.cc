...
//leptons, pt ordered only for top3
  ...
  // ----------------------------------------------------------------------------
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
      ...
      //// modification on GoldenJson. Lumisections that differed. (FWLJMET uses Cert_294927-306462_13TeV_PromptReco_Collisions17_75 JSON.txt ; recommended one is Cert_294927-306462_13TeV_EOY2017ReReco_Collisions17_JSON_v1.txt); Following events filtered to match between the two
      if (!isMC){
